...
class UserController extends Controller
{
  ...
  public function store(Request $request): RedirectResponse
  {
    ...
    $user = User::create([
      ...
      'role_id' => $request->role_id,
      'biodata' => $request->biodata ?? '', // Nilai default jika null
...
$user->profile()->create([
  'id' => Str::uuid(), // Generate UUID for the profile ID
  'biodata' => $request->biodata,
  'age' => $request->age,
  'address' => $request->address,
  ...
  public function destroy(User $user): RedirectResponse
  {
    ...
    $avatarPath = optional($user->profile)->avatar; // Menggunakan optional untuk menghindari kesalahan jika profile tidak ada
