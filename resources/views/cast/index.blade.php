...
<div class="page">
  ...
  <div class="page-wrapper">
      ...
      <div class="container-xl">
        <div class="row g-2 align-items-center">
          ...
          <div class="col-auto ms-auto d-print-none">
            <div class="btn-list">
            <a href="{{ route('casts.create') }}" class="btn btn-danger d-none d-sm-inline-block">
    <!-- Icon SVG -->
    ...
    <a href="{{ route('casts.show', $cast->id) }}" class="btn-sm btn-info">
    ...
    <a href="{{ route('casts.edit', $cast->id) }}" style="padding: 0; border: none; background: none;">
        ...
        <button type="button" class="delete-btn" onclick="showDialog('{{ route('casts.destroy', $cast->id) }}')">
...
<div class="dialog-container" id="dialogContainer">
    <div class="dialog-box">
      <p>Apakah Anda yakin ingin menghapus pemeran ini?</p>
