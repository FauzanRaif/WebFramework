    ...
    <div class="page-body">
      <div class="container-xl">
        <div class="card">
          ...
          required>{{ old('biodata', optional($user->profile)->biodata) }}</textarea>
       ...
       value="{{ old('age', optional($user->profile)->age) }}"
       ...
       value="{{ old('address', optional($user->profile)->address) }}" placeholder="Masukkan Alamat">
              ...
              <img id="avatar-preview" src="{{ asset('storage/' . optional($user->profile)->avatar) }}" alt="Avatar Preview"
