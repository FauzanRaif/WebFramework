...
<div class="page">
  ...
  <div class="page-wrapper">
    ...
    <textarea class="form-control" id="biodata" name="biodata" rows="3" readonly>
        {{ optional($user->profile)->biodata }}
    </textarea>
</div>
...
<div class="mb-3">
    ...
    <input type="number" class="form-control" id="age" name="age" 
           value="{{ optional($user->profile)->age }}" readonly>
</div>
...
<div class="mb-3">
    ...
    <input type="text" class="form-control" id="address" name="address"
           value="{{ optional($user->profile)->address }}" readonly>
</div>
