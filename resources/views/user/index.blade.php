...
<div class="page">
  ...
  <div class="page-wrapper">
      ...
      <div class="container-xl">
        <div class="row g-2 align-items-center">
          ...
          <div class="col-auto ms-auto d-print-none">
            <div class="btn-list">
            <a href="{{ route('users.create') }}" class="btn btn-danger d-none d-sm-inline-block">
    <!-- Icon SVG -->
            ...
            <div id="table-default" class="table-responsive">
              <table class="table" id="user-table">
                ...
                <tr>
                  ...
                  <th>
                    <button class="table-sort" data-sort="sort-email">Alamat Email</button>
                  </th>
                  <th>
                ...
                @forelse ($users as $user)
                  <tr>
                    ...
                    <td class="sort-biodata">
                      ...
                      {{ optional($user->profile)->biodata ? Str::limit($user->profile->biodata, 50) : '-' }}

                    </td>
                    <td class="sort-age">{{ optional($user->profile)->age ?? '-' }}</td>

                    <td class="sort-address">{{ optional($user->profile)->address ?? '-' }}</td>
    ...
    @endif
                    ...
                    <td class="sort-aksi">
                      <a href="{{ route('users.show', $user->id) }}" class="btn-sm btn-info">
            ...
            <path d="M21 12c-2.4 4 -5.4 6 -9 6c-3.6 0 -6.6 -2 -9 -6c2.4 -4 5.4 -6 9 -6c3.6 0 6.6 2 9 6" />
                      ...
                      <a href="{{ route('users.edit', $user->id) }}" style="padding: 0; border: none; background: none;">
    ...
    <button type="button" class="delete-btn" onclick="showDialog('{{ route('users.destroy', $user->id) }}')">
