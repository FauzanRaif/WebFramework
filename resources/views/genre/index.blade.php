...
<div class="page">
  ...
  <div class="page-wrapper">
      ...
      <div class="container-xl">
        <div class="row g-2 align-items-center">
          ...
          <div class="col-auto ms-auto d-print-none">
            <div class="btn-list">
            <a href="{{ route('genres.create') }}" class="btn btn-danger d-none d-sm-inline-block">
    <!-- Icon SVG -->
    ...
    <a href="{{ route('genres.show', $genre->id) }}" class="btn-sm btn-info">
    ...
    <a href="{{ route('genres.edit', $genre->id) }}" style="padding: 0; border: none; background: none;">
        ...
        <button type="button" class="delete-btn" onclick="showDialog('{{ route('genres.destroy', $genre->id) }}')">
